...
import 'package:flutter_api_guide/Models/product_model.dart';
import 'package:http/http.dart' as http;

class Withoutstartinglistbutobject extends StatefulWidget {
  const Withoutstartinglistbutobject({super.key});

  @override
  _LastExampleScreenState createState() => _LastExampleScreenState();
}

class _LastExampleScreenState extends State<Withoutstartinglistbutobject> {
