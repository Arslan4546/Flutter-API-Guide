...
class ProductsModel {
  ProductsModel({bool? success, String? message, List<Data>? data}) {
    _success = success;
    _message = message;
    _data = data;
  }
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _categories = json['categories'] != null
        ...
        : null;
    _subcate = json['subcate'] != null
        ? Subcate.fromJson(json['subcate'])
        : null;
...
class Images {
  Images({String? id, String? filename, String? url}) {
    _id = id;
    _filename = filename;
    _url = url;
  }
...
class Subcate {
  Subcate({String? id, String? date, String? name, String? parentid, int? v}) {
    _id = id;
    _date = date;
    _name = name;
    _parentid = parentid;
